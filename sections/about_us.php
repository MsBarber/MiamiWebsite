	...
	<div class="container">
		...
		<div class="section-header">
			...
			<?php
				...
				$zerif_aboutus_neilsbox = get_theme_mod('zerif_aboutus_neilsbox',__('Neil is cool.','zerif-lite'));
                
                
                

				if( !empty($zerif_aboutus_neilsbox) ):

					echo '<div class="white-text section-legend">';

						echo wp_kses_post( $zerif_aboutus_neilsbox );

					echo '</div>';

				elseif ( isset( $wp_customize ) ):
					
					echo '<div class="white-text section-legend zerif_hidden_if_not_customizer">'.$zerif_aboutus_neilsbox.'</h6>';
